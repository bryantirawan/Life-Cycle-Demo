...
class ViewController1: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        //this will fail because while destinationVC exists bc it is just ViewController2, destinationVC.label has not been created yet so it is nil
        //if you do destinationVC.label?.text = "Hello" then it is ok 
